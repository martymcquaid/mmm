        ...
        <section className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto text-white/90">
              ...
              or just want to share how much your dog loves our toys, we'd love to hear from you.
            </p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">hello@pawplay.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">1-800-PAW-PLAY</p>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl p-8">
                ...
                <p className="mb-6">Check out our FAQ section for quick answers to common questions.</p>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <p className="text-gray-600 mb-4">Join our community for daily tips, cute dog photos, and exclusive offers!</p>
