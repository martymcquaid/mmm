...
- **Dev Server URL**: `http://127.0.0.1:5248`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/e5190a93-6f39-463c-b529-7d1069a9304a/preview`
- **Port**: `5248`
...
4. The dev server is accessible at `http://127.0.0.1:5248`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/e5190a93-6f39-463c-b529-7d1069a9304a/preview`
